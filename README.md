...
- [cloudlens](https://github.com/one2nc/cloudlens) - A `k9s` like CLI for AWS and GCP.
...
- [dibo](https://github.com/anton-fuji/dibo) - A Go-based CLI to generate .dockerignore files, inspired by `gibo`.
...
- [lazykube](https://github.com/TNK-Studio/lazykube) - A terminal UI to manage K8s cluster.
...
- [sofka](https://github.com/nklmilojevic/sofka) - A Kubernetes terminal interface inspired by `k9s`.
...
- [termora](https://github.com/TermoraDev/termora) - A cross-platform terminal emulator and SSH client.
...
- [ldapx](https://github.com/Macmod/ldapx) - Flexible LDAP proxy to inspect & transform all LDAP packets generated by other tools on the fly.
...
- [cdncheck](https://github.com/projectdiscovery/cdncheck) - An utility to detect various technology for a given IP address.
...
- [cfspeedtest](https://github.com/code-inflation/cfspeedtest) - Unofficial CLI for speed.cloudflare.com.
...
- [goreplay](https://github.com/probelabs/goreplay) - A network monitoring tool which can record live traffic, and use it for shadowing, load testing, monitoring and detailed analysis.
- [gossl](https://github.com/vvrnv/gossl) - Simple CLI app for checking SSL certificates written in Go.
- [httpmonitor](https://github.com/ricoberger/httpmonitor) - A small TUI application to monitor a single or multiple targets.
...
- [mapcidr](https://github.com/projectdiscovery/mapcidr) - An utility program to perform multiple operations for a given subnet/CIDR ranges.
...
- [lazycurl](https://github.com/kbrdn1/LazyCurl) - A powerful TUI HTTP client.
...
- [ghgrab](https://github.com/abhixdd/ghgrab) - Migrated, use `main/ghgrab`.
...
- [trdsql](https://github.com/noborus/trdsql) - Migrated, use `main/trdsql`.
